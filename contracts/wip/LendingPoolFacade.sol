...
contract LendingPoolFacade is ILendingPoolFacade, Initializable, OwnableUpgradeSafe {
    ...
    function deposit(
        ...
        address cToken = reserveService.getReserveCTokenAddress(_reserve);
    ...
    function refreshConfigInternal() internal {
        ...
        userLoanDataService = ILendingPoolUserLoanDataService(AddressService.getLendingPoolUserLoanDataService());
    }
}
